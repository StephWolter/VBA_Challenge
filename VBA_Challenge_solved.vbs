Sub Calculations_For_Challenge()
...
'I deleted a bunch of dims up there and cell headers but I wanted to make note that I
'actually did try really hard to get this done but simply couldn't figure out how to get it to call
'from the ticker column. Not that I get credit but just saying I TRIED.
''Calculate Max/Min
...
'
''Populate Max/Min for Bonus
'Cells(3, 16).Value = FormatPercent(Max_Percent)
'Cells(4, 16).Value = FormatPercent(Min_Percent)
'Cells(5, 16).Value = Max_Volume
'
''Populate corresponding Ticker for Bonus
'Range("K:K").Find(Max_Percent) = Max_Percent_Ticker
'Range("K:K").Find(Min_Percent) = Min_Percent_Ticker
'Range("L:L").Find(Max_Volume) = Max_Volume_Ticker
'
